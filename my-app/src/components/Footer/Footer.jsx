      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
        ...
        <nav className="w-full md:w-1/3 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-8 text-3xl text-[#0a66c2]">
            <a
              href="https://www.linkedin.com/in/yasir-rabbani-tanvir/"
              target="_blank"
              rel="noreferrer"
              aria-label="LinkedIn"
            ...
            <a
              href="https://github.com/yasirrabbanitanvir"
              target="_blank"
              rel="noreferrer"
              aria-label="GitHub"
              className="transition-transform duration-200 ease-in-out hover:scale-125 text-white"
            >
              <RiGithubLine />
            </a>
            <a
